...
<body>
	<header><h1><a href="/">Project Nayuki</a></h1><nav><h2>Navigation</h2><ul><li><a href="/recent-pages/">Recent</a></li><li><a href="/category/programming">Programming</a></li><li><a href="/category/math">Math</a></li><li><a href="/page/native-hash-functions-for-java" title="Page: Native hash functions for Java">Random</a></li></ul><ul><li><a href="/page/about">About/Contact</a></li><li><a href="https://github.com/nayuki" onclick="if('gtag' in window)gtag('event','page_view',{page_path:'https://github.com/nayuki'});">GitHub</a></li></ul></nav></header>
	<hr/>
...
<img src="/res/miscellaneous/page-not-found-splash-image.jpg" style="display:block; margin:0em auto 1.5em; width:100%; max-width:35em"/>
<p style="max-width:unset">The path you requested (<strong style="padding:0.1em 0.4em; background-color:#ECF4FF; border-radius:0.2em">/res/qr-code-generator-library/qrcodegen-advanced.js</strong>) is not associated with a page or file.</p>
<p>Please try looking in these alternate places:</p>
<ul>
	<li><strong><a href="/page/qr-code-generator-library">Page “QR Code generator library”</a></strong></li>
	<li><a href="/page/">List of all pages</a></li>
	<li><a href="/">Front page</a></li>
	<li id="back" style="display:none">
		<script>
			if (window.history.length > 1)
				document.querySelector("article li#back").style.removeProperty("display");
		</script>
		<a href="#" onclick="event.preventDefault(); window.history.back();">Back to your previous page</a>
	</li>
</ul>
</article>
</div>
...
<nav>
	...
	<table>
		<tbody>
			<tr><td><a href="/page/avl-tree-list"><img src="/res/page-icon/64/avl-tree-list.png" alt="" fetchpriority="low"/></a></td><td><a href="/page/avl-tree-list">AVL tree list</a></td></tr>
			<tr><td><a href="/page/flac-library-java"><img src="/res/page-icon/64/flac-library-java.png" alt="" fetchpriority="low"/></a></td><td><a href="/page/flac-library-java">FLAC library (Java)</a></td></tr>
			<tr><td><a href="/page/manufactoria-solutions"><img src="/res/page-icon/64/manufactoria-solutions.png" alt="" fetchpriority="low"/></a></td><td><a href="/page/manufactoria-solutions">Manufactoria solutions</a></td></tr>
