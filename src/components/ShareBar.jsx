      ...
      {sensitive ? (
        <>
          ...
          <p className="hint centered" id="share-why">
            Off for {type.label.toLowerCase()} codes: a link holds the contents, and links end up in chat logs and
            screenshots. The settings file stays on your device.
          </p>
        </>
      ) : (
        <>
          ...
          <p className="hint centered">
            The link holds the text, colours and size, so it rebuilds exactly this code. The code itself never points
            here.
          </p>
        </>
      )}
