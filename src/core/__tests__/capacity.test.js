...
describe('capacity boundaries at version 40', () => {
  ...
  for (const ecc of ECC_LETTERS) {
    it(`fits exactly ${MAX_NUMERIC[ecc]} digits at level ${ecc}, and not one more`, () => {
  ...
  it('reports a helpful message rather than truncating', () => {
  ...
  it('never returns a result whose text differs from the input', () => {
...
describe('capacity reporting', () => {
  it('used bits never exceed capacity bits', () => {
  ...
  it('headroom shrinks as the payload grows', () => {
...
describe('empty and whitespace input', () => {
  ...
  it('encodes whitespace-only input rather than silently dropping it', () => {
...
describe('version floor', () => {
  it('honours a floor above the natural version', () => {
  ...
  it('rejects a nonsensical floor with a readable message', () => {
...
describe('mask selection', () => {
  it('uses the requested mask when one is given', () => {
  ...
  it('picks a mask automatically by default', () => {
...
describe('error correction boosting', () => {
  it('reports the level actually used, not the level requested', () => {
  ...
  it('never changes the version when boosting', () => {
